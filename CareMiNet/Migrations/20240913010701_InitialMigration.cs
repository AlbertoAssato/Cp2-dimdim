...
namespace CareMiNet.Migrations
{
    /// <inheritdoc />
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_cm_medico", x => x.CdMedico);
                });

            migrationBuilder.CreateTable(
                name: "t_cm_plano_saude",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_cm_plano_saude", x => x.CdPlanoSaude);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_cm_usuario", x => x.CdUsuario);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_cm_login", x => x.CdLogin);
                    table.ForeignKey(
                        name: "FK_t_cm_login_t_cm_usuario_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "t_cm_usuario",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioCdUsuario = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_cm_paciente", x => x.CdPaciente);
                    table.ForeignKey(
                        name: "FK_t_cm_paciente_t_cm_usuario_UsuarioCdUsuario",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_cm_agendamento_exame", x => x.CdAgendamento);
                    table.ForeignKey(
                        name: "FK_t_cm_agendamento_exame_t_cm_medico_MedicoId",
                        column: x => x.MedicoId,
                        principalTable: "t_cm_medico",
                        principalColumn: "CdMedico",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_t_cm_agendamento_exame_t_cm_paciente_PacienteId",
                        column: x => x.PacienteId,
                        principalTable: "t_cm_paciente",
                        principalColumn: "CdPaciente");
                });

            migrationBuilder.CreateTable(
                name: "t_cm_carteirinha",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_cm_carteirinha", x => x.CdCarteirinha);
                    table.ForeignKey(
                        name: "FK_t_cm_carteirinha_t_cm_paciente_PacienteCdPaciente",
            ...
            migrationBuilder.CreateTable(
                name: "t_cm_paciente_plano_saude",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_cm_paciente_plano_saude", x => new { x.PacienteId, x.PlanoSaudeId });
                    table.ForeignKey(
                        name: "FK_t_cm_paciente_plano_saude_t_cm_paciente_PacienteCdPaciente",
                        column: x => x.PacienteCdPaciente,
                        principalTable: "t_cm_paciente",
                        principalColumn: "CdPaciente");
                    table.ForeignKey(
                        name: "FK_t_cm_paciente_plano_saude_t_cm_paciente_PacienteId",
                        column: x => x.PacienteId,
                        principalTable: "t_cm_paciente",
                        principalColumn: "CdPaciente",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_t_cm_paciente_plano_saude_t_cm_plano_saude_PlanoSaudeCdPlanoSaude",
                        column: x => x.PlanoSaudeCdPlanoSaude,
                        principalTable: "t_cm_plano_saude",
                        principalColumn: "CdPlanoSaude");
                    table.ForeignKey(
                        name: "FK_t_cm_paciente_plano_saude_t_cm_plano_saude_PlanoSaudeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_cm_exame", x => x.CdExame);
                    table.ForeignKey(
                        name: "FK_t_cm_exame_t_cm_agendamento_exame_AgendamentoExameId",
                        column: x => x.AgendamentoExameId,
                        principalTable: "t_cm_agendamento_exame",
                        principalColumn: "CdAgendamento");
                });

            migrationBuilder.CreateTable(
                name: "t_cm_resultado_exame",
                columns: table => new
                {
                    ...
                    TExameCdExame = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_t_cm_resultado_exame", x => x.CdResultado);
                    table.ForeignKey(
                        name: "FK_t_cm_resultado_exame_t_cm_exame_TExameCdExame",
                        column: x => x.TExameCdExame,
                        principalTable: "t_cm_exame",
                        principalColumn: "CdExame",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_t_cm_agendamento_exame_MedicoId",
                table: "t_cm_agendamento_exame",
                column: "MedicoId");

            migrationBuilder.CreateIndex(
                name: "IX_t_cm_agendamento_exame_PacienteId",
                table: "t_cm_agendamento_exame",
                column: "PacienteId");

            migrationBuilder.CreateIndex(
                name: "IX_t_cm_carteirinha_PacienteCdPaciente",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_t_cm_exame_AgendamentoExameId",
                table: "t_cm_exame",
                column: "AgendamentoExameId");

            migrationBuilder.CreateIndex(
                name: "IX_t_cm_login_UsuarioId",
                table: "t_cm_login",
                column: "UsuarioId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_t_cm_paciente_UsuarioCdUsuario",
                table: "t_cm_paciente",
                column: "UsuarioCdUsuario",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_t_cm_paciente_plano_saude_PacienteCdPaciente",
                table: "t_cm_paciente_plano_saude",
                column: "PacienteCdPaciente");

            migrationBuilder.CreateIndex(
                name: "IX_t_cm_paciente_plano_saude_PlanoSaudeCdPlanoSaude",
                table: "t_cm_paciente_plano_saude",
                column: "PlanoSaudeCdPlanoSaude");

            migrationBuilder.CreateIndex(
                name: "IX_t_cm_paciente_plano_saude_PlanoSaudeId",
                table: "t_cm_paciente_plano_saude",
                column: "PlanoSaudeId");

            migrationBuilder.CreateIndex(
                name: "IX_t_cm_resultado_exame_TExameCdExame",
