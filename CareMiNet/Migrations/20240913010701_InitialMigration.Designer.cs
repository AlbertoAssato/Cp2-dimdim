...
namespace CareMiNet.Migrations
{
    ...
    [Migration("20240913010701_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CareMIAPI.Models.AgendamentoExame", b =>
                {
                    ...
                    b.ToTable("t_cm_agendamento_exame");
                });

            modelBuilder.Entity("CareMIAPI.Models.Carteirinha", b =>
                {
                    ...
                    b.ToTable("t_cm_carteirinha");
                });

            modelBuilder.Entity("CareMIAPI.Models.Exame", b =>
                {
                    ...
                    b.ToTable("t_cm_exame");
                });

            modelBuilder.Entity("CareMIAPI.Models.Login", b =>
                {
                    ...
                    b.ToTable("t_cm_login");
                });

            modelBuilder.Entity("CareMIAPI.Models.Medico", b =>
                {
                    ...
                    b.ToTable("t_cm_medico");
                });

            modelBuilder.Entity("CareMIAPI.Models.Paciente", b =>
                {
                    ...
                    b.ToTable("t_cm_paciente");
                });

            modelBuilder.Entity("CareMIAPI.Models.PacientePlanoSaude", b =>
                {
                    b.Property<int>("PacienteId")
                        .HasColumnType("NUMBER(10)");
                    ...
                    b.ToTable("t_cm_paciente_plano_saude");
                });

            modelBuilder.Entity("CareMIAPI.Models.PlanoSaude", b =>
                {
                    ...
                    b.ToTable("t_cm_plano_saude");
                });

            modelBuilder.Entity("CareMIAPI.Models.ResultadoExame", b =>
                {
                    ...
                    b.ToTable("t_cm_resultado_exame");
                });

            modelBuilder.Entity("CareMIAPI.Models.Usuario", b =>
                {
                    ...
                    b.ToTable("t_cm_usuario");
                });

            modelBuilder.Entity("CareMIAPI.Models.AgendamentoExame", b =>
                {
                    b.HasOne("CareMIAPI.Models.Medico", "Medico")
                        .WithMany("AgendamentoExame")
                        .HasForeignKey("MedicoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CareMIAPI.Models.Paciente", "Paciente")
                        .WithMany("AgendamentoExame")
            ...
            modelBuilder.Entity("CareMIAPI.Models.Carteirinha", b =>
                {
                    b.HasOne("CareMIAPI.Models.Paciente", "Paciente")
                        .WithOne("Carteirinha")
                        .HasForeignKey("CareMIAPI.Models.Carteirinha", "PacienteCdPaciente");
            ...
            modelBuilder.Entity("CareMIAPI.Models.Exame", b =>
                {
                    b.HasOne("CareMIAPI.Models.AgendamentoExame", "AgendamentoExame")
                        .WithMany("Exame")
            ...
            modelBuilder.Entity("CareMIAPI.Models.Login", b =>
                {
                    b.HasOne("CareMIAPI.Models.Usuario", "Usuario")
                        .WithOne("Login")
                        .HasForeignKey("CareMIAPI.Models.Login", "UsuarioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CareMIAPI.Models.Paciente", b =>
                {
                    b.HasOne("CareMIAPI.Models.Usuario", "Usuario")
                        .WithOne("Paciente")
                        .HasForeignKey("CareMIAPI.Models.Paciente", "UsuarioCdUsuario")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CareMIAPI.Models.PacientePlanoSaude", b =>
                {
                    b.HasOne("CareMIAPI.Models.Paciente", null)
                    ...
                    b.HasOne("CareMIAPI.Models.PlanoSaude", null)
                        .WithMany("PacientePlanosSaude")
                        .HasForeignKey("PlanoSaudeCdPlanoSaude");

                    b.HasOne("CareMIAPI.Models.PlanoSaude", "PlanoSaude")
                        .WithMany()
            ...
            modelBuilder.Entity("CareMIAPI.Models.ResultadoExame", b =>
                {
                    b.HasOne("CareMIAPI.Models.Exame", "Exame")
                        .WithOne("ResultadoExame")
                        .HasForeignKey("CareMIAPI.Models.ResultadoExame", "TExameCdExame")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
